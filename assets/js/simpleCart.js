        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                ukuran: function (item, column) {
                    return ["<span class='size'>Ukuran</span> " + item.get(column.attr)];
                },
                    ...
                    for (j = 0, jlen = settings.cartColumns.length; j < jlen; j += 1) {
                        ...
                        $(".item_subtotal").each(function () {
                            ...
                            if (lihat == "Keterangan: undefined") {
                                $(this).parents(".itemRow").find(".item_subtotal").remove();
                            }
                        });
                    }
                    return row;
            ...
            simpleCart.extend({
                checkout: function (opts) {
                    ...
                    simpleCart.each(function (item, x) {
                        ...
                        data["item_ukuran_" + counter] = item.get("ukuran");
                        data["item_warna_" + counter] = item.get("warna");
...
$(document).ready(function () {
    var dev = 'UHV0cmkgRGluYXI=', /* Putri Dinar */
    myLicense = atob(dev),
    tpllc = $('#footer').text(),
    second = 10;
